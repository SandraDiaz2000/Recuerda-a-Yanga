            ...
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <div class="img-container">
                        <img src="\img\comunidades\laguna.jpg" alt="team member" class="img-full">
                    </div>
                </div>
                <div class="col-lg-9 col-md-8">
                    <div class="member_designation">
                        <h2>La Laguna del Carmen</h2>
                        <span></span>
                    </div>
                  <br>  
                  <div class="member_desc">
                    <div class="member_desc">
                        ...
                        Comunidad perteneciente a Yanga. Es integrada por 1,000 habitantes y se ubica a 6 Km de distancia de la cabecera municipal.
