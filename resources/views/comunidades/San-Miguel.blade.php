            ...
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <div class="img-container">
                        <img src="\img\comunidades\miguel.jpg" alt="team member" class="img-full">
                    </div>
                </div>
                <div class="col-lg-9 col-md-8">
                    <div class="member_designation">
                        <h2>San Miguel el Grande</h2>
                        <span></span>
                    </div>
                  <br>  
                  <div class="member_desc">
                    <div class="member_desc">
                        ...
                        Comunidad perteneciente a Yanga. Es integrada por 2,200 habitantes y a 8 km de distancia de la cabecera municipal.
